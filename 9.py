...
print(f"Registration number of Car is {my_car.registration_number}: The Max speed of car is {my_car.max_speed} km/h, Current speed {my_car.current_speed} km/h, Travelled distance {my_car.travelled_distance} km")
